...
public class GetLogComplaintPopupService {
  private static final String TAG = GetLogComplaintPopupService.class.getSimpleName();
  ...
  public GetLogComplaintPopupService(
