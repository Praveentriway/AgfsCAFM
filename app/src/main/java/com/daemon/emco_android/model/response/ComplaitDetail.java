...
public class ComplaitDetail {
  ...
  /** @param complaintDate The complaintDate */
  ...
  /** @param complaintType The complaintType */
  ...
  /** @param vendorCode The vendorCode */
  ...
  /** @param complaintCode The complaintCode */
  ...
  /** @param customerReferenceNumber The customerReferenceNumber */
  public void setCustomerReferenceNumber(String customerReferenceNumber) {
    this.customerReferenceNumber = customerReferenceNumber;
  }

  /** @return The complaintMobileNumber */
  public String getComplaintMobileNumber() {
    return complaintMobileNumber;
  }

  /** @param complaintMobileNumber The complaintMobileNumber */
  ...
  /** @param customerFeedback The customerFeedback */
  ...
  /** @return The webComplaintReferenceNo */
  public String getWebComplaintReferenceNo() {
    return webComplaintReferenceNo;
  }

  /** @param webComplaintReferenceNo The webComplaintReferenceNo */
  ...
  /** @return The quotationJob */
  public String getQuotationJob() {
    return quotationJob;
  }

  /** @param quotationJob The quotationJob */
