...
public class ObjectMonthly implements Serializable {
    ...
    @SerializedName("Control Panel")
    @Expose
    private List<ControlPanel> controlPanel = null;
    ...
    public List<ControlPanel> getControlPanel() {
        return controlPanel;
    }

    public void setControlPanel(List<ControlPanel> controlPanel) {
