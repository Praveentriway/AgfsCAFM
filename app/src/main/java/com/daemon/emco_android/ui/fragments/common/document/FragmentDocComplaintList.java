...
public class FragmentDocComplaintList extends Fragment implements SupportDocumentRepository.SupportDocI,DocumentComplaintListAdapter.DocumentListOnClick {
    ...
    public FragmentDocComplaintList() {
    ...
    public void onDocumentListItemClicked(List<ReactiveSupportDoc> temp, int position) {
        ...
        loadFragment(new FragmentDocumentListing(), Utils.FRAGMENT_DOC_LIST);
