...
public class ReceiveReactivecomplaintListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ReceiveReactivecomplaintListAdapter(AppCompatActivity mActivity, List<ReceiveComplaintItemEntity> data) {
        TAG = "RC_ListAdapter";
        Log.d(MODULE, TAG);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_item_reactivecomplaint, parent, false);
