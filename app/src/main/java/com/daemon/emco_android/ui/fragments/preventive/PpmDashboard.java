...
public class PpmDashboard extends Fragment implements View.OnClickListener  {
    ...
    CardView btn_ppm_schedule,btn_ppm_documents;
    ...
    private void initUI(View rootView) {
        ...
        try {
            ...
            btn_ppm_schedule = (CardView) rootView.findViewById(R.id.btn_ppm_schedule);
            btn_ppm_documents = (CardView) rootView.findViewById(R.id.btn_ppm_documents);
            setupActionBar();
