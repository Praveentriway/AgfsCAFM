...
public class AssetVerificationFragment extends Fragment implements AssetVerificationRepository.Listener {
    ...
    public AssetVerificationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_asset_verification, container, false);
    ...
    public void initView() {
        ...
        linear_add_tag=(LinearLayout) view.findViewById(R.id.linear_add_tag);
        ...
        linear_add_tag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...
// Set up the buttons
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
              ...
              //  loadFragment(new AssetDetailFragment(),"");
        ...
        if (requestCode == AS_BARCODE_CAPTURE) {
            if (resultCode == CommonStatusCodes.SUCCESS) {
                if (data != null) {
                    ...
                    showDialog(getContext(),barcode.displayValue);
    ...
    public void loadFragmentAddTag(final Fragment fragment,String tag) {
