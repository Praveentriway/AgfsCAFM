...
public class PM_RiskAssessment_ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PM_RiskAssessment_ListAdapter(AppCompatActivity mActivity, List<PPENameEntity> data, List<PPEFetchSaveEntity> fetchdata) {
        TAG = "RC_ListAdapter";
        Log.d(MODULE, TAG);
