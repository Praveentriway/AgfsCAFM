...
public class FragmentAfterPpm extends Fragment implements ImagePickListener, DefectDoneImage_Listener,CustomRecyclerViewDataAdapter.ImageListner  {
    private static final String TAG = FragmentAfterPpm.class.getSimpleName();
