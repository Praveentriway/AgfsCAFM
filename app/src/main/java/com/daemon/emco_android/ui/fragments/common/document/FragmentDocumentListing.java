...
public class FragmentDocumentListing extends Fragment implements DocumentUploadRepository.ImageListner,DocumentListingAdapter.ItemListner {
    ...
    public FragmentDocumentListing() {
    ...
    public void setProps(){
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loadFragment(new FragmentDocumentUpload(),rxDoc,docTrans,docCount, Utils.TAG_FRAGMENT_DOC_UPLOAD);
    ...
    public void onViewClick(int pos, DocumentTransaction trans, List<DocumentTransaction> transList){
        loadFragment(new FragmentDocumentUpload(),rxDoc,trans,transList.size()-(pos+1), Utils.TAG_FRAGMENT_DOC_UPLOAD);
    }
