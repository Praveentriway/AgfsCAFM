 ...
 */
public class Fragment_PPM_Material extends Fragment implements Material_Listener {

    private static String TAG = Fragment_PPM_Material.class.getSimpleName();
    //private ReceiveComplaintViewEntity receiveComplaintViewEntity;
    List<SaveMaterialEntity> saveMaterialRequests = new ArrayList<>();
            ...
            sac_material_search.setOnQueryTextListener(
                    new SearchView.OnQueryTextListener() {
                        ...
                        public boolean onQueryTextSubmit(String query) {
                            sac_material_search.clearFocus();
                            sac_material_search.setEnabled(false);
                            submitQuery(query);
                            return false;
                        }
    ...
    private void submitQuery(String query) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(query)) {
                ...
                mCurrentnoOfRows = 0;
                mQuery = query;
                mOpco = ppmScheduleDocBy.getCompanyCode();
        ...
        try {
                ...
                if (mSavegetList != null) {
                    for (int i = 0; i < mSavegetList.size(); i++) {
                        ...
                        if (entity != null
                            ...
                            request.setDocType("P");
                            request.setComplaintNumber("");
                            request.setComplainSite("");
                            ...
                            request.setRefrenceDocNumber(ppmScheduleDocBy.getPpmNo());
                            request.setRefrenceDocDate(ppmScheduleDocBy.getPpmDate());
            ...
            if (saveMaterialRequests.isEmpty()) {
                ...
                if (network_available) {
                    ...
                    rcMaterial_service.PostPPMSaveMaterialData(saveMaterialRequests);
                } else {
    ...
    public void setupActionBar() {
        ...
        tv_toolbar_title.setText(isMaterialRequired ? R.string.lbl_material_reqd : R.string.lbl_material_used);
    /*mToolbar.setTitle(
        getResources()
            .getString(
        ...
        try {
            ...
            if (getMaterialEntities.size() > 0) {
                ...
                if (!mgetList.isEmpty() && from == AppUtils.MODE_SERVER) {
                    new RCSavedMaterialDbInitializer(mActivity, this, mgetList).execute(AppUtils.MODE_INSERT);
                }
