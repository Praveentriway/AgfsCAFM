...
public class CustomerFeedbackSignature extends Fragment implements CustomerSurveyService.SaveListener {

    private AppCompatActivity mActivity;
    Toolbar mToolbar;
    TextView tv_toolbar_title;
    private static final String TAG = CustomerFeedbackSignature.class.getSimpleName();
   ...
   public CustomerFeedbackSignature() {
    ...
    public  void saveSurvey(){
       if(tie_suggestion.getText().toString().equalsIgnoreCase("") ){
    ...
    public void call(){
        ...
        new CustomerSurveyService(mActivity,this).saveSurvey(surveyTransaction);
    }
