...
/**
 * Created by Vikram on 18-Dec-16.
 */

public class BottomViewBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    private static final String TAG = BottomViewBehavior.class.getSimpleName();
    ...
    private BottomView.OnNavigationPositionListener navigationPositionListener;
     ...
     */
    public void setOnNavigationPositionListener(BottomView.OnNavigationPositionListener navigationHeightListener) {
